...
//{
//    public class Cohort : Landis.Library.AgeOnlyCohorts.ICohort, Landis.Library.DensityCohorts.ICohort 
//    {
//        public static event Landis.Library.DensityCohorts.DeathEventHandler<Landis.Library.DensityCohorts.DeathEventArgs> DeathEvent;
//        public static event Landis.Library.DensityCohorts.DeathEventHandler<Landis.Library.DensityCohorts.DeathEventArgs> AgeOnlyDeathEvent;
...
//        public delegate void AddLitter(float AddLitter, ISpeciesDensity Species);
...
//        private ISpeciesDensity species;
...
//            {
//                //FIXME
//                // Provide the function for converting treenumber, diameter to biomass
//                return (int)(1);
//            }
//        }
//        // Number of trees
...
//        public ISpeciesDensity SpeciesDensity
//        {
//            get
//            {
//                return species;
...
//            get
//            {
//                return PlugIn.SpeciesDensity[species];
//            }
//        }
...
//        public Cohort(ISpeciesDensity species, ushort age, int treenumber, float diameter, string SiteName, ushort firstYear)
//        {
//            //InitializeSubLayers();
//            this.species = species;
//            this.age = age;
...
//        {
//            //FIXME - Calculate foliage biomass
...
//            //FIXME - Is this right?
//            treenumber = (int)Math.Round(treenumber * (1.0 - fraction));
