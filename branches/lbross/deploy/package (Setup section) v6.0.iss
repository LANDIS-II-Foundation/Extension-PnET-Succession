...
#define LandisPlugInDir    LandisBinDir + "\extensions"

; The directory where LANDIS-II code is built for deployment
#define LandisBuildDir     "C:\Program Files\LANDIS-II\v6\bin\extensions"
...
#define CoreDir            LandisInstallDir + "\" + "v6"
#define CoreBinDir         CoreDir + "\bin\extensions"

#define PluginAdminDir  LandisInstallDir + "\6.0\bin"
