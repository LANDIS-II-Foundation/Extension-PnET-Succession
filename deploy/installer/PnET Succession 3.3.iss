...
Source: {#BuildDir}\Landis.Extension.Succession.BiomassPnET-v3.dll; DestDir: {#ExtDir}; Flags: ignoreversion
...
Source: {#BuildDir}\Seed_Dispersal.dll; DestDir: {#ExtDir}; Flags: uninsneveruninstall replacesameversion
